...
func NewTransport(key ic.PrivKey, connManager *quicreuse.ConnManager, psk pnet.PSK, gater connmgr.ConnectionGater, rcmgr network.ResourceManager, opts ...p2ptls.IdentityOption) (tpt.Transport, error) {
	if len(psk) > 0 {
